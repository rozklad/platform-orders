...
;(function(window, document, $, undefined)
{
	...
	Extension.Index.datePicker = function()
	{
		...
		$('.daterangepicker_start_input').attr('data-grid', 'deliverystatus');

		$('.daterangepicker_end_input').attr('data-grid', 'deliverystatus');
	...
	Extension.Index.dataGrid = function()
	{
		...
		Extension.Index.Grid = $.datagrid('deliverystatus', '#data-grid', '#data-grid_pagination', '#data-grid_applied', config);
