...
;(function(window, document, $, undefined)
{
	...
	Extension.Index.datePicker = function()
	{
		...
		$('.daterangepicker_start_input').attr('data-grid', 'payment');

		$('.daterangepicker_end_input').attr('data-grid', 'payment');
	...
	Extension.Index.dataGrid = function()
	{
		...
		Extension.Index.Grid = $.datagrid('payment', '#data-grid', '#data-grid_pagination', '#data-grid_applied', config);
