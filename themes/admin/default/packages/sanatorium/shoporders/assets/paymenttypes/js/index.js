...
;(function(window, document, $, undefined)
{
	...
	Extension.Index.datePicker = function()
	{
		...
		$('.daterangepicker_start_input').attr('data-grid', 'paymenttype');

		$('.daterangepicker_end_input').attr('data-grid', 'paymenttype');
	...
	Extension.Index.dataGrid = function()
	{
		...
		Extension.Index.Grid = $.datagrid('paymenttype', '#data-grid', '#data-grid_pagination', '#data-grid_applied', config);
