...
;(function(window, document, $, undefined)
{
	...
	Extension.Index.datePicker = function()
	{
		...
		$('.daterangepicker_start_input').attr('data-grid', 'deliverytype');

		$('.daterangepicker_end_input').attr('data-grid', 'deliverytype');
	...
	Extension.Index.dataGrid = function()
	{
		...
		Extension.Index.Grid = $.datagrid('deliverytype', '#data-grid', '#data-grid_pagination', '#data-grid_applied', config);
