...
@section('title')
@parent
{{ trans('sanatorium/orders::payments/common.title') }}
@stop
...
{{ Asset::queue('index', 'sanatorium/orders::payments/js/index.js', 'platform') }}
...
<section class="panel panel-default panel-grid">
		...
		<nav class="navbar navbar-default navbar-actions">
			...
			<div class="container-fluid">
				...
				<div class="navbar-header">
					...
					<span class="navbar-brand">{{{ trans('sanatorium/orders::payments/common.title') }}}</span>
				...
				<div class="collapse navbar-collapse" id="actions">
					...
					<ul class="nav navbar-nav navbar-left">
						...
						<li class="primary">
							<a href="{{ route('admin.sanatorium.orders.payments.create') }}" data-toggle="tooltip" data-original-title="{{{ trans('action.create') }}}">
					...
					{{-- Grid: Filters --}}
					<form class="navbar-form navbar-right" method="post" accept-charset="utf-8" data-search data-grid="payment" role="form">
						...
						<div class="input-group">
							...
							<span class="input-group-btn">
								...
								<ul class="dropdown-menu" role="menu">
									...
									<li>
										<a data-grid="payment" data-filter="enabled:1" data-label="enabled::{{{ trans('common.all_enabled') }}}" data-reset>
											<i class="fa fa-eye"></i> {{{ trans('common.show_enabled') }}}
										</a>
									</li>

									<li>
										<a data-toggle="tooltip" data-placement="top" data-original-title="" data-grid="payment" data-filter="enabled:0" data-label="enabled::{{{ trans('common.all_disabled') }}}" data-reset>
							...
							<span class="input-group-btn">
								...
								<button class="btn btn-default" data-grid="payment" data-reset>
	...
	<div class="panel-body">
		...
		<div class="btn-toolbar" role="toolbar" aria-label="data-grid-applied-filters">
			...
			<div id="data-grid_applied" class="btn-group" data-grid="payment"></div>
	...
	<div class="table-responsive">
		...
		<table id="data-grid" class="table table-hover" data-source="{{ route('admin.sanatorium.orders.payments.grid') }}" data-grid="payment">
			<thead>
				<tr>
					<th><input data-grid-checkbox="all" type="checkbox"></th>
					<th class="sortable" data-sort="id">{{{ trans('sanatorium/orders::payments/model.general.id') }}}</th>
					<th class="sortable" data-sort="payment_status_id">{{{ trans('sanatorium/orders::payments/model.general.payment_status_id') }}}</th>
					<th class="sortable" data-sort="payment_type_id">{{{ trans('sanatorium/orders::payments/model.general.payment_type_id') }}}</th>
					<th class="sortable" data-sort="money_id">{{{ trans('sanatorium/orders::payments/model.general.money_id') }}}</th>
					<th class="sortable" data-sort="created_at">{{{ trans('sanatorium/orders::payments/model.general.created_at') }}}</th>
				</tr>
			</thead>
			<tbody></tbody>
		</table>
	...
	<footer class="panel-footer clearfix">
		...
		{{-- Grid: Pagination --}}
		<div id="data-grid_pagination" data-grid="payment"></div>

	</footer>

	{{-- Grid: templates --}}
	@include('sanatorium/orders::payments/grid/index/results')
	@include('sanatorium/orders::payments/grid/index/pagination')
	@include('sanatorium/orders::payments/grid/index/filters')
	@include('sanatorium/orders::payments/grid/index/no_results')

</section>

@if (config('platform.app.help'))
	@include('sanatorium/orders::payments/help')
@endif
