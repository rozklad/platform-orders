...
;(function(window, document, $, undefined)
{
	...
	Extension.Index.datePicker = function()
	{
		...
		$('.daterangepicker_start_input').attr('data-grid', 'customer');

		$('.daterangepicker_end_input').attr('data-grid', 'customer');
	...
	Extension.Index.dataGrid = function()
	{
		...
		Extension.Index.Grid = $.datagrid('customer', '#data-grid', '#data-grid_pagination', '#data-grid_applied', config);
